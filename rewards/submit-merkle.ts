...
export const submitMerkle = async (asset: string, automated: boolean) => {
    ...
    const tx2 = await aggregator.proposeAndDistribute(
        newMerkleTree.merkleRoot, currentCycle + 1, newMerkleTree.startBlock, newMerkleTree.endBlock,
        CONFIG[asset].merkleDistributor, CONFIG[asset].rewardCollectorForFee,
